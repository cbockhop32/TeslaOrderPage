        ...
        <div className="Paint">
            ...
            <div className="Paint-Selector">
                 <div className="Paint-Option">
                    <input checked={currentColor === 'white'} type="radio" role="button" name="paint" id="paintWhite" readOnly></input>
                ...
                <div className="Paint-Option">
                    <input checked={currentColor === 'black'} type="radio" role="button" name="paint" id="paintBlack" readOnly></input>
                ...
                <div className="Paint-Option">
                    <input checked={currentColor === 'silver'} type="radio" role="button" name="paint" id="paintSilver" readOnly></input>
                ...
                <div className="Paint-Option">
                    <input checked={currentColor === 'blue'} type="radio" role="button" name="paint" id="paintBlue" readOnly></input>
                ...
                <div className="Paint-Option">
                    <input checked={currentColor === 'red'} type="radio" role="button" name="paint" id="paintRed" readOnly></input>
